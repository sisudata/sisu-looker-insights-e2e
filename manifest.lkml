...
application: looker_e2e_test {
  ...
  entitlements: {
    use_embeds: yes
    use_form_submit: yes
    external_api_urls : ["http://localhost:5005", "http://localhost:808", "https://api.segment.io", "https://cdn.segment.com", "https://edge.fullstory.com", "https://rs.fullstory.com", "https://sentry.io"]
