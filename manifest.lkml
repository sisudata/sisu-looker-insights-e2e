...
application: sisu-insights {
  ...
  entitlements: {
    use_embeds: yes
    use_form_submit: yes
    external_api_urls : ["https://gcp-dev.sisu.ai", "https://sentry.io", "https://cdn.segment.com", "https://api.segment.io", "https://edge.fullstory.com","https://rs.fullstory.com"]
    ...
    new_window : yes
    new_window_external_urls: [ "https://gcp-dev.sisu.ai/*", "mailto:support@sisudata.com", "https://docs.sisudata.com/docs/looker-insights/faq"]
    oauth2_urls: ["https://gcp-dev.sisu.ai/oauth/authorize"]
  }
  mount_points: {
