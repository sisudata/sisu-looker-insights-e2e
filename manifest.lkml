...
application: looker_e2e_test {
  ...
  entitlements: {
    use_embeds: yes
    use_form_submit: yes
    external_api_urls : ["http://localhost:500", "http://localhost:8080", "https://api.segment.io", "https://cdn.segment.com", "https://edge.fullstory.com", "https://rs.fullstory.com", "https://sentry.io"]
